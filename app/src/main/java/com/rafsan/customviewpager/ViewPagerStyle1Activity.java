package com.rafsan.customviewpager;
...
public class ViewPagerStyle1Activity extends FragmentActivity {
    ...
    private void btnAction(int action){
    	switch(action){
    	  case 0: setButton(_btn1,"1",60,60); setButton(_btn2,"",30,30);break;
    	  
    	  case 1: setButton(_btn2,"2",60,60); setButton(_btn1,"",30,30); break;
    	}
    }
